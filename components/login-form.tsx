...
window.location.href = (data.role === "admin") ? "/admin/dashboard" : "/employee/dashboard";
  ...
  <div className="relative">
    <Input
      ...
      required
      className="border-slate-300 focus:border-[#005A9C] focus:ring-[#005A9C] transition-all duration-300 pr-10"
    />

    <button
      type="button"
      onClick={() => setShowPassword(!showPassword)}
      className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-600 hover:text-[#005A9C]"
    >
